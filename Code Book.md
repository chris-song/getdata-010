From the original Samsung data set, we select all variables (aka columns) that represent the mean and standard deviation for each measurement. The output is a table with 50 columns. Details below:
